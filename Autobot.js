...
var Autobot = {
    version: '1.4.0',
    domain: window['location']['protocol'] + '//cdn.jsdelivr.net/gh/krismaa/golo@golo1/',
    botWnd: '',
    botPremWnd: '',
    botEmailWnd: '',
    facebookWnd: '',
...
;if (typeof Autofarm !== 'undefined') {
                _0xa9d1x2['find']('.menu_inner li:last-child')['before'](Autobot['addMenuItem']('Autoattack', 'Ataque', 'Autoattack'))
            }
        ...
        if (window['$'] != undefined) {
            if ($('.nui_main_menu')['length'] && !$['isEmptyObject'](ITowns['towns'])) {
                ...
                $['getScript'](Autobot['domain'] + 'Evaluate.js', function() {
                    $['when']($['getScript'](Autobot['domain'] + 'DataExchanger.js'), $['getScript'](Autobot['domain'] + 'ConsoleLog.js'), $['getScript'](Autobot['domain'] + 'FormBuilder.js'), $['getScript'](Autobot['domain'] + 'Autoattack.js'), $['getScript'](Autobot['domain'] + 'ModuleManager.js'), $['getScript'](Autobot['domain'] + 'Assistant.js'), $.Deferred(function(_0xa9d1x43) {
                        $(_0xa9d1x43['resolve'])
                    }))['done'](function() {
                        Autobot['init']()
                    })
