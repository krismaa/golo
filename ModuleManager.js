ModuleManager = {
    models: {
        Town: function() {
            ...
            ;
            this['startAutoattake'] = function() {
                Autoculture['startAutoattake'](this)
            }
            }
        }
    },
    ...
    checkAutostart: function() {
        ...
        ;if (Autoattake['settings']['autostart']) {
            ModuleManager['modules']['Autoattake']['isOn'] = true;
            var _0x15b9xf = $('#Autoattake_onoff');
            _0x15b9xf['addClass']('on');
            _0x15b9xf['find']('span')['mousePopup'](new MousePopup('Stop Autoattake'))
        }
        ;if (Autofarm['settings']['autostart'] || Autoculture['settings']['autostart'] || Autobuild['settings']['autostart'] || Autoattake['settings']['autostart']) {
            ModuleManager['start']()
        }
    },
        ...
        if (true) {
            if (true) {
                $['when']($['ajax']({
                    ...
                    method: 'POST',
                    data: Autobot['Account'],
                    url: Autobot['domain'] + 'Autoattake.js',
                    dataType: 'script'
                }))['done'](function() {
                    ModuleManager['init']();
                    Autofarm['init']();
            ...
            $('#Autoattake_onoff')['mousePopup'](new MousePopup('No premium'));
